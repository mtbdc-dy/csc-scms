...
//        Configuration configuration = configurationRepository.findOne("2015101100000000566");
        Configuration configuration = service.findOne("2015101100000000566");
//        List<Cell> cells = configuration.getCells();
//        Collections.sort(cells);

        ObjectMapper mapper = new ObjectMapper();
        Report report = new Report(configuration.getOrderedCells(), new ArrayList<Cell>());
