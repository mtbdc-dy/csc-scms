...
//public static Map<String,List> MAP = new HashMap<String, List>();
    //点击查询返回代码维护列表
//    @RequestMapping(value = "/stureg1", method = RequestMethod.GET, headers = "Accept=application/json; charset=utf-8;Cache-Control=no-cache")
...
//    }
    ...
    public ResponseEntity<Page<Map<String, Object>>> getNewStuTimeSet(
        ...
        try {
            ...
            Page<ImportLog> importLogsPage = importLogService.getImportLogsPagingByFilter(filter, page, size, mode, user,"1");
