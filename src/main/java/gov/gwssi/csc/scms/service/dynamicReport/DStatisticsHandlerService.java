...
public class DStatisticsHandlerService extends BaseService {
    ...
    @Transactional
    public ReturnStatistics save(ReportConfiguration reportConfiguration, List<DTableList> dTableList, List<DCondition> dConditions, List<DDisplay> dDisplays){
        ...
        if(configId != null && !configId.equals("")){
            if(reportConfiguration != null){
                saveDConfig(reportConfiguration, configId);
            }
            if(dTableList != null){
    ...
    //  保存动态查询配置表
    public void saveDConfig(ReportConfiguration reportConfiguration,String configId){
            if(configId != null && !configId.equals("") && reportConfiguration != null){
                reportConfiguration.setId(configId);
                reportConfigurationRepository.save(reportConfiguration);
            }
    ...
    public String getConfigSQLByConfigId(String configId){
        String dConfigSQL = "";
        ReportConfiguration reportConfiguration =  reportConfigurationRepository.findOne(configId);
        if(reportConfiguration != null){
            dConfigSQL = reportConfiguration.getSql();
        }
        return dConfigSQL;
    }
