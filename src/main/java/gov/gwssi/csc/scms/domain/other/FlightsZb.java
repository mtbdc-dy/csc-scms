 ...
 */
@Entity
@Table(name = "SCMS_FLIGHTS_ZB")
public class FlightsZb {
    @Id
    private String id;
    private String user_name;
    private String destination;
    private Date passport_valid;
    ...
    public Date getPassport_valid() {
        return passport_valid;
    }

    public void setPassport_valid(Date passport_valid) {
        this.passport_valid = passport_valid;
    }
